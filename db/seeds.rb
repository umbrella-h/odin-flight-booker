...
ActiveRecord::Base.connection.tables.each do |table|
  ...
  # SQLite
   ActiveRecord::Base.connection.execute("DELETE FROM #{table}") unless table == "schema_migrations"
	...
	{dep_airport_id: airports.first.id, arr_airport_id: airports.last.id, dep_time: "2020-12-02 09:00:00", duration: 6}, 
	...
	{dep_airport_id: airports.last.id, arr_airport_id: airports.first.id, dep_time: "2020-12-01 13:00:00", duration: 8}, 
